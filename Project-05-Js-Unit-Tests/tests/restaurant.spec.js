...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    //   fetchMenu: () => { },
    // };
    // expect(Object.keys(menu)[2]).toBe('fetchMenu');
    // // expect(Object.values(menu)[2]).toEqual(Object.values(fetch)[0]);
    // expect(menu).toContain((fetch));
    const indexKey = Object.keys(createMenu()).indexOf('fetchMenu');
    expect(typeof Object.values(createMenu())[indexKey]).toEqual('function');
